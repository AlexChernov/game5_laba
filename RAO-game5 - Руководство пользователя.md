...
2. Запустить RAO-studio
   ...
   ![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img01.png "RAO_studio меню Просмотр")
   
   Рис. 1. RAO_studio меню Просмотр
   
3. Из меню `Просмотр` открыть `Настройки`

   ![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img02.png "Диалоговое окно настроек")
...
6. В появившемся меню `Плагины` активировать работу плагина
   ...
   ![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img03.png "Активация плагина пятнашек")
...
![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img04.png "Вкладка Fun")
...
![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img05.png "Окно настройки начального состояния игрового поля")
...
![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img06.png "Диалоговое окно задания игровой ситуации с клавиатуры")

Рис. 6. Диалоговое окно задания игровой ситуации с клавиатуры

![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img07.png "Результат задания игровой ситуации с клавиатуры")
...
![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img08.png "Расширенное окно настройки начального состояния игрового поля")
...
* **Прохождение графа** - раздел, определяющий необходимость сравнивать в процессе поиска новые вершины с уже существующими. Если снять флажок `Сравнивать вершину с раскрытыми` возможно зайти в цикл при расчете, т.к. система не будет ‘знать’, что она уже была в этой вершине
* **Стоимость принятия правил** - раздел, определяющий правила построения графа. В нашей модели таких правил четыре - перемещение фишек в различные направления: вправо, влево, вверх и вниз
  ...
  * `Стоимость` - арифметическое выражение, определяющее стоимость применения этого правила. По умолчанию значение `1`, наличие флажка позволяет его редактировать. В этом разделе пользователь может использовать функции, например `Кол_во_фишек_не_на_месте(0)` или задать свою 
...
![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img09.png "Окно графа")
...
![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img10.png "Окно информации о вершине")
...
![Alt text](https://github.com/AlexChernov/game5_laba/raw/master/img/Img11.png "Меню масштабирования")
