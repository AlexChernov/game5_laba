...
* `Задать..` -  задание игровой ситуации с клавиатуры, при этом номера фишек разделяются пробелами, позиция пустого места отмечается `0`. Например, `1 5 2 4 0 3` - задаст ситуацию, приведенную на рисунке ?
