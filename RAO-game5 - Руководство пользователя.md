...
Раздел активностей заполняется автоматически, но на основе значений из диалогового окна создания начальой ситации, пользователь может повлиять на поля `(value before | value after)` и `стоимость применения правила`. Значения для этих полей задаются в разделе **Стоимость принятия правил**
